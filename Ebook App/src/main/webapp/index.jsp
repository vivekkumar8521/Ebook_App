...
<title>Vivek's Book Store</title>
<%@include file="all_component/allCss.jsp"%>
<style type="text/css">  
.back-img {
	background: url('img/web.jpeg') no-repeat center center;
...
<div class="container-fluid back-img">
    <h2 style="text-align: right; color: white; font-family: 'Arial', sans-serif;">Our Platform Provides</h2>
    <p style="color: white; font-family: 'Arial', sans-serif"> <marquee>One Stop Solution For All Books</marquee></p>
</div>
	...
	<div class="container">
		...
		<div class="row">
			...
			List<BookDtls> list2 = dao2.getAllBooks();
